function NavLayout({children}) {
    ...
    return (
        <div className="d-flex flex-column vh-100">
            ...
            <div className="d-flex flex-row h-100 overflow-hidden">
                <div className="">
                    <SideBar/>
                </div>
    ...
    return (
        <div className="p-3 border-bottom bg-light d-flex align-items-center shadow-sm justify-content-between">
            ...
            <div className="d-flex align-items-center ms-2">
                <div className="ms-2">Usuario</div>
            </div>
        </div>
    )
}
...
function SideBar() {
    return (
        <div className="bg-light border-end d-flex flex-column h-100" style={{width: "220px"}}>
