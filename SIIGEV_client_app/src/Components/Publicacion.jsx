...
export default function Publicacion({publicacion, maestroNombre, clase_id}) {
    let linkTo = "";
    if(publicacion.tipo === "materiales" || publicacion.tipo === "tareas"){
        linkTo = publicacion.tipo === "materiales" ? `/m/clase/${clase_id}/material/${publicacion.id}`
            : `/m/clase/${clase_id}/tarea/${publicacion.id}`;
    }
