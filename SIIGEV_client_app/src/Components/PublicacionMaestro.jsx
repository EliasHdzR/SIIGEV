        ...
        <Link to={linkTo} key={publicacion.id} className="list-group-item mb-2 border rounded z-1">
            ...
            {publicacion.tipo === "tareas" && (
                <>
                    ...
                    <p className="fw-bold text-muted mb-0">Entregas</p>
                    <p className="fw-bold text-muted">Calificadas {publicacion.entregas.cantCalificadas} | Entregadas {publicacion.entregas.cantEntregadas} |
                    Asignadas {publicacion.entregas.cantAsignadas}</p>
                </>
            )}
            {publicacion.tipo === "materiales" && (
